        ...
        <div class="flex items-center justify-between border border-gray-200  bg-white shadow-md rounded-lg mb-3">
            ...
            <div class="container mx-auto my-5 px-4 md:px-6 lg:px-8">
                <form onsubmit="validarDatos(event)" method="post" action="/reporte" enctype="multipart/form-data">
                    ...
                    <!--Opciones de reporte-->
                    <fieldset class="mb-4">
                        <p class="text-gray-700 font-bold mb-2">Su reporte es: <span class="text-red-500">*</span>
                        </p>
                    ...
                    <div class="mb-4">
                        <label for="formFile" class="block font-bold mb-2">Adjuntar una imagen (Opcional)</label>
                        <div class="w-full py-9 bg-gray-50 rounded-2xl border border-gray-300 gap-3 grid border-dashed">
                            <div class="grid gap-1">
                                ...
                                <h2 class="text-center text-gray-400 text-xs leading-4">PNG, JPG o JPEG, de menos de 5 MB
                                </h2>
                            </div>
                            <div class="grid gap-2">
                                <h4 class="text-center text-gray-900 text-sm font-medium leading-snug">Arrastre y suelte su
                    ...
                    <div class="mt-6 flex justify-center space-x-4">
                        ...
                        <a href="{{ route('welcome') }}" type="button"
                            class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition duration-300 ease-in-out transform hover:scale-105">
                            Regresar
                        </a>

                        <!-- Botón Enviar -->
                        <button type="submit"
                            class="text-white bg-[#092534] hover:bg-[#041e27] focus:ring-4 focus:ring-[#041e27] font-medium rounded-md text-md px-4 py-2 focus:outline-none transition duration-300 ease-in-out transform hover:scale-105">
                            Enviar
                        </button>
                    </div>
                </form>
